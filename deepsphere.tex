...
\begin{minipage}{.2\textwidth}
	...
	\captionof{figure}{Circle $1$-dimentional Manifold embedded in a 2-dimentional space. Green: Manifold. Red: the regular sampled point and graph vertices. Blue: graph edges.}
	\label{fig:ring}
\end{minipage}
\hspace{1cm}
