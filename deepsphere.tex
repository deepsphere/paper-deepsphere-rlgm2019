...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.2\linewidth]{ring}
	\caption{Circle $1$-dimentional Manifold embedded in a 2-dimentional space. Green: Manifold. Red: the regular sampled point and graph vertices. Blue: graph edges.}
	\label{fig:ring}
\end{figure}
